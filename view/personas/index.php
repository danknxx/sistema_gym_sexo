...
?>
<div clasas="mb-3">
    <a href="/sistema_gym/view/personas/create.php" class="btn btn-primary">Agregar nueva persona</a>
...
<table class="table">
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="3" class="text-center">No hay registrosactualmente</td>
            </tr>
    <?php endif; ?>
    </tbody>
</table>
