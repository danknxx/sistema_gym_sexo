...
<div class="card-body">
    ...
    <p class="card-text">
        <strong>CODIGO: </strong><?=$registro["idPersona"]?><br>
        <strong>CÉDULA: </strong><?=$registro["cedula"]?><br>
        <strong>NOMBRE: </strong><?=$registro["nombre"]?><br>
        <strong>APELLIDO: </strong><?=$registro["apellido"]?><br>
        <strong>FEC. NACIM.: </strong><?=$registro["fechaNacimiento"]?><br>
        <strong>EMAIL: </strong><?=$registro["correoElectronico"]?><br>
