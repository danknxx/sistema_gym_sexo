        ...
        <?php if($rows): ?>
            <?php foreach($rows as $row): ?>
                ...
                <th><?= $row['nombre_rol'] ?></th>
                    <th>
                        <a href="show.php?id=<?= $row['idroles']?>" class="btn btn-primary">Ver</a>
                        <a href="edit.php?id=<?= $row['idroles']?>" class="btn btn-success">Modificar</a>
                        <!-- Button trigger modal -->
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#id<?=$row['idroles']?>">Eliminar</a>

                        <!-- Modal -->
                        <div class="modal fade" id="id<?=$row['idroles']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delete.php?id=<?= $row['idroles']?>" class="btn btn-danger">Eliminar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
